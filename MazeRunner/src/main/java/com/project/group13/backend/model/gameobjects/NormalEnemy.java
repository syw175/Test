...
/**
 * Represents a normal moving enemy in the game.
 * Normal enemies move in a pre-defined path
 *
 * @author Ali Nikan
 * @author Kelvin Lu
 * @author Steven Wong
 ...
 * @version 1.0
 */
public class NormalEnemy extends AutoMovingObject implements Enemy {
     ...
     */
    public NormalEnemy(Position coordinate, Directions orientation, int movementRange, Axis movementAxis, double movementSpeed, int power) {
